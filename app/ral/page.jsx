...
export default function RalPage() {
  ...
  const ralIpotetica = calcRalIpotetica(payslips);
        ...
        <>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            ...
            <StatCard
              ...
              sub={`Proiezione ${ralIpotetica?.anno}`}
          ...
          <Section title="Come calcoliamo la RAL ipotetica">
            ...
            <Row label="× 13 mensilità" value={formatEuro(ralIpotetica?.base13)} />
          ...
          <p className="text-xs text-slate-500 -mt-3 px-1">
            ...
            l'indennità mensa/ticket, che non fa parte della RAL contrattuale). Il bonus
            produzione riflette solo le tranche già documentate nelle buste caricate: se manca
            ancora una tranche, il totale sarà provvisorio.
          </p>
        </>
      )}
    </main>
